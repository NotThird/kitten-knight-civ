...
export function migrateState(s, {
  ...
  if (!('punitiveTolerance' in s.social.norms)) s.social.norms.punitiveTolerance = 0;
  ...
  s.social.norms.punitiveTolerance = (typeof clamp01 === 'function') ? clamp01(Number(s.social.norms.punitiveTolerance ?? 0)) : Math.max(0, Math.min(1, Number(s.social.norms.punitiveTolerance ?? 0) || 0));
  ...
  if (!('punitiveBand' in s.social)) s.social.punitiveBand = 'lenient';
  if (!('punitiveLastAt' in s.social)) s.social.punitiveLastAt = 0;
  s.social.punitiveBand = String(s.social.punitiveBand ?? 'lenient');
  s.social.punitiveLastAt = Number(s.social.punitiveLastAt ?? 0) || 0;
